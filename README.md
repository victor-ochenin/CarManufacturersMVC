...
> Важно: Полная документация доступна на отдельном сайте. Откройте: [CarManufacturersMVC — Docs (GitHub Pages)](https://victor-ochenin.github.io/CarManufacturersMVC/). Исходники сайта — в ветке `docs-site`.
